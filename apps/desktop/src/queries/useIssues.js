...
function useIssues(state) {
    ...
    return (0, react_query_1.useQuery)({
        queryKey: ["issues", activeWorkspaceId, state, repos === null || repos === void 0 ? void 0 : repos.map(function (r) { return r.fullName; })],
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(repos.map(function (repo) {
                                return github_1.githubIpc
                                    ...
                                    .then(function (issues) { return issues.map(function (issue) { return (__assign(__assign({}, issue), { repoFullName: repo.fullName })); }); })
                                    .catch(function (e) {
                                    console.error("Failed to fetch issues for ".concat(repo.fullName, ":"), e);
                                    return [];
                                });
                            }))];
                    case 1:
