...
function useDashboardStats() {
    ...
    return (0, react_query_1.useQuery)({
        queryKey: ["dashboard", activeWorkspaceId, repos === null || repos === void 0 ? void 0 : repos.map(function (r) { return r.fullName; })],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!repos || repos.length === 0) {
                    return [2 /*return*/, { totalOpenPrs: 0, totalOpenIssues: 0, prsNeedingReview: 0, recentlyMerged: 0 }];
                }
                return [2 /*return*/, github_1.githubIpc.getDashboard(repos.map(function (r) { return ({ owner: r.owner, repo: r.name }); }))];
            });
        }); },
