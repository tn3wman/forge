...
function AddWorkspaceDialog(_a) {
    var open = _a.open, onOpenChange = _a.onOpenChange, onCreated = _a.onCreated;
    var _b = (0, react_1.useState)(""), name = _b[0], setName = _b[1];
    var createWorkspace = (0, useWorkspaces_1.useCreateWorkspace)();
    var setActiveWorkspaceId = (0, workspaceStore_1.useWorkspaceStore)().setActiveWorkspaceId;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!name.trim())
                            return [2 /*return*/];
                        return [4 /*yield*/, createWorkspace.mutateAsync({ name: name.trim() })];
                    case 1:
                        workspace = _a.sent();
    ...
    return (<dialog_1.Dialog open={open} onOpenChange={onOpenChange}>
      <dialog_1.DialogContent className="sm:max-w-[400px]">
        <dialog_1.DialogHeader>
          <dialog_1.DialogTitle>Create Workspace</dialog_1.DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <input_1.Input id="workspace-name" placeholder="e.g. Work, Personal, OSS" value={name} onChange={function (e) { return setName(e.target.value); }} autoFocus/>
          </div>
          <div className="flex justify-end gap-2">
            <button_1.Button type="button" variant="outline" onClick={function () { return onOpenChange(false); }}>
              Cancel
            </button_1.Button>
            <button_1.Button type="submit" disabled={!name.trim() || createWorkspace.isPending}>
